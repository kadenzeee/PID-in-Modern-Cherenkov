...
\subsection{\label{sec:mass-spectrometry}Mass Spectrometry}
\vspace{1em}
\input{Sections/theoretical-foundations/mass-spectrometry.tex}

\subsection{\label{sec:statistical-event-reconstruction-methods}Statistical Foundations of Event Reconstruction}
\vspace{1em}
