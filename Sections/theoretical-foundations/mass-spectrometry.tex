...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{Images/cherenkov-angle.png}
...
provide measurement of the Cherenkov angle by reconstructing the cone through analysis of the photon hits. 
Topology-imaging detectors (such as Super-K in Sect \nolinebreak\ref{sec:neutrino-identification})
map the entire Cherenkov cone of photons using sensors over a huge area, and can obtain momentum estimates
