...
\label{sec:optical-detector-theory}
...
and the behaviour of light in various media. Fig \ref{fig:panda-bd-event-display} shows a 
simulated event display of PANDA's Barrel DIRC detector \cite{Singh_2019}, illustrating how
...
will be discussed further in § \textcolor{red}{sec:photon-optics} and § \textcolor{red}{sec:applications-at-future-facilities}. 