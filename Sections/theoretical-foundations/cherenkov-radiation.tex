...
aircraft. The angle \(\theta\) can be derived from simple geometric considerations shown in Fig \nolinebreak\ref{fig:cherenkov-diagram}, yielding the following:
...
This velocity spectroscopy for various particle species is shown in Fig \nolinebreak\ref{fig:cherenkov-angle-COMPASS}.
...
particle species. These curves can be determined mathematically using \nolinebreak\eqref{equ:cherenkov-critical-angle} and relativistic
dynamics \nolinebreak\cite{Tessarotto_2014}.\label{fig:cherenkov-angle-COMPASS}}
\end{figure}
