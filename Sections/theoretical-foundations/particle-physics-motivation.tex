...
into quantum chromodynamics. Many types of particle physics experiments require PID
...
shown in Fig \nolinebreak\ref{fig:ePIC-pid-requirements}. These detector performance metrics will
...
between around 1 and 10 GeV\c. Here, \(\eta\) represents the pseudorapidity \nolinebreak\cite{hpDIRC-Greg_2025}}\label{fig:ePIC-pid-requirements}
\end{figure}
