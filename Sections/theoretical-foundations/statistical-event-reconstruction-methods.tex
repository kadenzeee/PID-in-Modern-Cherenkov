...
\begin{equation}
    \mathcal{L}_h = \prod_{i=1}^{N} \frac{1}{\sqrt{2 \pi} \sigma} \exp \left( -{\frac{( t_i - \langle t_{i,h} \rangle)^2}{2 \sigma^2}} \right)
\end{equation}
where \(t_i\) is the detected time of the \(i\)-th photon, \(\langle t_{i,h} \rangle\) is the expected time
...
One potential new-age solution is the use of machine learning (ML). This aims to skip 
