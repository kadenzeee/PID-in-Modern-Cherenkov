...
Devices that detect internally reflected Cherenkov light are a type of Cherenkov imaging detector are called DIRCs for short. They circumvent the need for a separate radiator by using solid transparent bars, typically quartz, to both generate and guide Cherenkov photons to the photodetectors. Fig \nolinebreak\ref{fig:panda-dirc} shows a detailed rendering of the PANDA barrel detector \nolinebreak\cite{Singh_2019}. 
...
reconstruction from chromatic effects can complicate hit–track association in high-multiplicity collider environments compared to spatially imaging RICH detectors. 
