...
Event reconstruction in a DIRC system is inherently more complicated than in RICH systems, due to the 
many reflections in the path of the photons. 


\textcolor{red}{Put lower level stuff about ml pid here, try to justify your project}
...
(DNNs) and normalising flows \nolinebreak\cite{Fanelli_2025} are also being explored.