...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{Images/simple-rich-detector.png}
...
such as in the Belle II ARICH \nolinebreak\cite{abe2010belleiitechnicaldesign}, gaseous radiators such as in
...
Consider the Cherenkov angle condition from Eq \nolinebreak\ref{equ:cherenkov-critical-angle}. The radiator
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{Images/pfRICH-conical-mirrors.png}
...
\subsubsection{Mechanics \& Integration}
