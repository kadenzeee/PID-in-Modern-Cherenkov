...
\end{equation}
At a fixed momentum, varying \(\theta_c\) provides separation between particle hypotheses with different masses. 
...
In modern detector arrays at collider setups, forward tracking detectors provide momentum measurements. Then, Cherenkov accelerator-based PID detectors (such as RICHs in Sect \nolinebreak\ref{sec:rich}) provide measurement of the Cherenkov angle through analysis of the Cherenkov photon hits incident on a photodetector array. This pair of reconstructed observables can be used to distinguish between different particle types.
