...
for the PANDA Barrel DIRC ask for a QE of 18\% between 300–400nm \nolinebreak\cite{panda-mcps-Katje_2025}. 
...
Timing characteristics are also very important. The timing resolution of the MCP-PMT refers to the å
uncertainty when the detector reports a single photon hit. Modern MCP-PMTs
are pushing 15ps time resolution \nolinebreak\cite{Lyashenko_2026}. A lower timing resolution allows us to be more precise with
...
asks for a photoelectron rate capability of 500 \(\text{kHz/cm}^2\) \nolinebreak\cite{panda-mcps-Katje_2025}.
