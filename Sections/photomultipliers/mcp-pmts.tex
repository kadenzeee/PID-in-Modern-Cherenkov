...
In detector physics we are interested in a few properties of MCP-PMTs. 
\begin{itemize}
\item Firstly,
...
\item Secondly, the consistency of accurate hits is of great interest. We want uniform gain
...
\item Timing characteristics are also very important. The time resolution of the MCP-PMT is
often measured with the entire data acquisition system (DAQ) included, and modern photodetectors
are pushing 100ps time resolution. This is a measure of how quickly a hit is detected after a 
laser pulse directly on the detector. A lower timing resolution allows us to be more precise with
...
before becoming too saturated and DAQ not being able to distinguish clear hits. The PANDA Barrel 
asks for a photoelectron rate capability of 500 \(\text{kHz/cm}^2\) \cite{panda-mcps-Katje_2025}.

\item Lastly, the lifetime of the MCP-PMT is of interest. If we are building detectors with price 
...
indulging here. However, it should be emphasised that this is a topic that is 
