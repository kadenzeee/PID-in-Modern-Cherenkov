...
ALD coatings also significantly improve the sensor ageing \nolinebreak\cite{2013NIMPA.732..388C},
the LAPPDs themselves have been shown to have impressive spatial and temporal resolution \nolinebreak\cite{LYASHENKO2020162834}, and further 
characterisations of HRPPDs, a high-rate upgrade for LAPPDs, are ongoing \nolinebreak\cite{LYASHENKO2026170964,lappd-foulds-holt_2025}.

On the software side developments being researched, particularly for DIRCs, are as described in Sect \nolinebreak\ref{sec:reconstruction-methods}. 
ML has the potential to offer fast particle classification, either alone or in conjunction with other PID methods to speed up their compute time. 
...
electronics is therefore an active area of research, particularly for LAPPDs.
