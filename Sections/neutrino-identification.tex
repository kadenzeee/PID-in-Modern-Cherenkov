...
While track-based PID detectors such as DIRC can not directly detect neutrally charged neutrinos,
...
to use easy or natural materials such as water or ice. This presents a unique set of engineering 
...
Fig \nolinebreak\ref{fig:ice-cube-event-display} shows such a cosmic event from IceCube, where a high energy neutrino has interacted with the ice
